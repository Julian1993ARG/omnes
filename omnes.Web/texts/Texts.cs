    ...
    public static partial class Texts
    {
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static readonly LocalText EmailSubject = "Reset Your omnes Password";
                ...
                {
                    public static readonly LocalText ActivateEmailSubject = "Activate Your omnes Account";
            ...
            public static readonly LocalText SiteTitle = "omnes";
        }
