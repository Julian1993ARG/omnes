    ...
    public class DataMigrations : IDataMigrations
    {
        ...
        private void EnsureDatabase(string databaseKey)
        {
            ...
            catch (SqlException ex)
            {
                ...
                if (cb.ConnectionString.Contains(oldVer, StringComparison.Ordinal))
                    throw new InvalidOperationException(
                        ...
                        cs.ConnectionString.Replace(oldVer, @"\MSSqlLocalDB", StringComparison.Ordinal) + "\r\n\r\nor:\r\n\r\n" +
                        cs.ConnectionString.Replace(oldVer, @"\v12.0", StringComparison.Ordinal) + "';\r\n\r\n" +
        ...
        private void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want omnes migrations to run on your DB.
            ...
            var migrationNamespace = "omnes.Migrations." + databaseKey + "DB";
