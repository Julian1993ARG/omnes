...
namespace omnes.Membership.Pages
{
            ...
            IEmailSender emailSender, ISMSService smsService)
        {
                 ...
                 (user.TwoFactorAuth == TwoFactorAuthType.Email)))
            {
                ...
                if (user.TwoFactorAuth == TwoFactorAuthType.SMS)
                {
                    ...
                    smsService.Send(
                        phoneNumber: mobile,
                        text: "Please use code " + data.TwoFactorCode + " for omnes login.",
                        reason: "Sent by omnes system for two factor authenication by SMS (" + user.Username + ")");
                ...
                else
                {
                    ...
                    emailSender.Send(
                        mailTo: user.Email,
                        subject: "Your two-factor authentication code for omnes login",
                        body: "Please use code " + data.TwoFactorCode + " for omnes login.");
